var AIChatEmbed = (() => {
  ...
  // src/ai-chat-embed.js
  var ai_chat_embed_exports = {};
  __export(ai_chat_embed_exports, {
    default: () => ai_chat_embed_default,
    init: () => init
  });
  var DEFAULTS = {
  ...
  function applyVue2Shims() {
    ...
    if (typeof window.Vue.component !== "function") {
      window.Vue.component = function componentShim() {
        return this;
      };
    }
    if (typeof window.Vue.extend !== "function") {
      window.Vue.extend = function extendShim(optionsArg) {
        return function Vue2CompatCtor(props) {
          return { ...optionsArg, props };
        };
      };
    }
    if (typeof window.Vue.set !== "function") {
      window.Vue.set = function setShim(target, key, value) {
        target[key] = value;
        return value;
      };
    }
    if (typeof window.Vue.delete !== "function") {
      window.Vue.delete = function deleteShim(target, key) {
        delete target[key];
      };
    }
  }
  ...
  async function init(userOptions = {}) {
    ...
    const defaultContainerId = mode === "panel" ? "ai-chat-panel-root" : DEFAULTS.containerId;
    const rootOptions = {
      ...DEFAULTS,
  ...
  var AIChatEmbed = AIChatEmbedCore;
  if (typeof window !== "undefined") {
    window.AIChatEmbed = AIChatEmbed;
  }
  var ai_chat_embed_default = AIChatEmbed;
  return __toCommonJS(ai_chat_embed_exports);
})();
//# sourceMappingURL=ai-chat-embed.js.map
